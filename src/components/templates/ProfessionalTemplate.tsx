...
export const ProfessionalTemplate = forwardRef<HTMLDivElement, TemplateProps>(({ data }, ref) => {
    return (
        <div className="resume-document professional-template" ref={ref}>
            <div className="professional-top-border"></div>
